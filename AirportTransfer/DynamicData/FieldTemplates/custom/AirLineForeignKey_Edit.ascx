<%@ Control Language="C#" CodeBehind="AirLineForeignKey_Edit.ascx.cs" Inherits="AirportTransfer.AirLineForeignKey_EditField" %>

            <%@ Register src="../../../UI/UserControls/CListControl.ascx" tagname="CListControl" tagprefix="uc1" %>
            ...
            <tr>
                <td>
                    [<div class="divListBoxMode">
                        ...
                        <uc1:CListControl ID="CListControl1" runat="server" />
                    </div>]
                </td>
                <td>
                    (*)
