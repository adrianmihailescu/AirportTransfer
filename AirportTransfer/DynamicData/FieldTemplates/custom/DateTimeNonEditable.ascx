<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DateTimeNonEditable.ascx.cs" Inherits="AirportTransfer.DynamicData.FieldTemplates.custom.DateTimeNonEditable" %>
